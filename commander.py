...
@click.option('--source_chassis_card_port', default='', help='10.10.10.10;1;5')
@click.option('--dest_chassis_card_port', default='', help='10.10.10.10;1;6')
...
def parse_args(session_name, linux_api_server, linux_api_server_username, linux_api_server_password,
               source_chassis_card_port, dest_chassis_card_port, linerate, packetsize, ixiaconfigfilepath, operation):
